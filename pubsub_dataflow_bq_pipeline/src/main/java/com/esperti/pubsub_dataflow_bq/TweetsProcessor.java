...
package com.esperti.pubsub_dataflow_bq;
...
public class TweetsProcessor
{
	...
	private static final Logger LOG = LoggerFactory.getLogger(TweetsProcessor.class);

	private static final String APPLICATION_NAME =  "TtcTweetsAnalysisPipleline";
        ...
        public void processElement(DoFn<String, String>.ProcessContext c) throws Exception {
            try {
                ...
                if (jsonTweet != null && jsonTweet.getAsJsonPrimitive("text") != null && jsonTweet.getAsJsonPrimitive("lang") != null) {
                    ...
                    // Process the element only if it contains "ttc" (even not as an hashtag)
	...
	public static void main(String[] args) {
		...
		tweets = p.apply(PubsubIO.Read.named("Read tweets from Pub Sub").topic("projects/"+ project_id+ "/topic/ttc_tweets"));
        ...
        tableReference.setDatasetId("ttc_analytics");
        ...
        filteredTableReference.setProjectId(project_id);
        filteredTableReference.setDatasetId("ttc_analytics");
