...
public class TweetsProcessor
{
	...
	private static final String APPLICATION_NAME =  "TweetsAnalysisPipleline";
	...
	public static void main(String[] args) {
        ...
        tableReference.setDatasetId("epl_analytics");
        ...
        filteredTableReference.setDatasetId("epl_analytics");
